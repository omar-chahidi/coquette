 ...
 */
final class Version20200730155150 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, ville_id INT NOT NULL, utilisateur_id INT NOT NULL, nom_adresse VARCHAR(255) NOT NULL, prenom_adresse VARCHAR(255) NOT NULL, telephone_adresse VARCHAR(255) NOT NULL, adresse LONGTEXT NOT NULL, INDEX IDX_C35F0816A73F0036 (ville_id), INDEX IDX_C35F0816FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, domaine_id INT NOT NULL, marque_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, created_at DATE NOT NULL, prix NUMERIC(7, 2) NOT NULL, remise INT DEFAULT NULL, tva NUMERIC(5, 2) DEFAULT NULL, INDEX IDX_23A0E66BCF5E72D (categorie_id), INDEX IDX_23A0E664272FC9F (domaine_id), INDEX IDX_23A0E664827B9B2 (marque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom_utilisateur VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, date_naissance DATE DEFAULT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, activation VARCHAR(10) NOT NULL, date_ajout DATE DEFAULT NULL, date_desactivation DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
